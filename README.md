...
tests/              # 491 тест: парсеры (фикстуры с реальной разметкой), фичи, БД, бот, API, фронт-приёмка, train-smoke, артефакты модели
tests/e2e/          # 35 браузерных e2e (pytest-playwright): 32 герметичных против uvicorn+Chromium и 3 live-smoke
```
